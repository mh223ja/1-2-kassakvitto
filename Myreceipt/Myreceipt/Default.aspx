...
<body>
    ...
    <div>
        ...
        <asp:CompareValidator ID="CompareValidator1" runat="server" ErrorMessage="You need to enter a whole number" ControlToValidate="TextBox1" Display="Dynamic" ForeColor="Red" Operator="DataTypeCheck" Type="Double">*</asp:CompareValidator>
